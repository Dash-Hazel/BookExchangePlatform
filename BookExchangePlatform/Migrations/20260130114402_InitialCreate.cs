    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangeBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExchangeBooks_Books_OfferedBookId",
                        column: x => x.OfferedBookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeBooks_Books_RequestedBookId",
                        column: x => x.RequestedBookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeBooks_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeBooks_Users_RequesterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeBooks_OfferedBookId",
                table: "ExchangeBooks",
                column: "OfferedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeBooks_OwnerId",
                table: "ExchangeBooks",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeBooks_RequestedBookId",
                table: "ExchangeBooks",
                column: "RequestedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeBooks_RequesterId",
                table: "ExchangeBooks",
                column: "RequesterId");
        }
